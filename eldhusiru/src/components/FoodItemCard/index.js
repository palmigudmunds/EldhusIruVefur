...
function FoodItemCard({ name, prices, ingredients, image, imageAlt }) {
    ...
    return (
        <div className='flex flex-row items-center w-full max-[1185px]:h-56 bg-white rounded-2xl p-5 hover:shadow-xl ease-in-out duration-150 hover:cursor-pointer'>
